...
<!---
<div style="text-align: center; margin-top: 20px;">
    ##### Want to be notified for the next blog?q
</div>
-->
...
<input type="email" placeholder="Enter your email address" name="email" required="" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px; width: 250px;"> <button type="submit" style="padding: 8px 15px; background-color: #4c61afff; color: white; border: none; border-radius: 4px; cursor: pointer;"> Submit </button>
-->
